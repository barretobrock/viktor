...
class TableSlackUser(Base):
    ...
    def __init__(self, slack_user_hash: str, real_name: str, display_name: str, role_title: str = None,
                 role_desc: str = None, level: float = 0., ltits: float = 0., **kwargs):
...
class TableSlackUserChangeLog(Base):
    ...
    status_text = Column(VARCHAR(120))
    role_title = Column(TEXT)
    role_desc = Column(TEXT)
    avatar_link_192 = Column(VARCHAR(255))

    def __init__(self, real_name: str = None, display_name: str = None, status_text: str = None, role_title: str = None,
                 role_desc: str = None, avatar_link_192: str = None, **kwargs):
        self.real_name = real_name
        self.display_name = display_name
        self.status_text = status_text
        self.role_title = role_title
        self.role_desc = role_desc
        self.avatar_link_192 = avatar_link_192
    ...
    def __repr__(self) -> str:
        return f'<TableSlackUserChangeLog(name{self.real_name}, display_name={self.display_name}, ' \
               f'status_text={self.status_text[:20]})>'
